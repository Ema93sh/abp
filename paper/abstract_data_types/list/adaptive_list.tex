...
\title{Adaptive List: What does it mean?}
...
% Themes: Motivation!
In this paper we explore the idea of an adaptive list and what it means to be an adaptive list.
...
\section{Conclusion}
We have explored different approaches to what it means to be an adaptive list and found that one
approach works better and more suitable than others. Using this approach, we have further extended
the adaptive programming paradim.
